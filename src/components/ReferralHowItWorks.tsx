...
const steps = [
  ...
  },
  {
    ...
    text: 'По твоей ссылке друг входит через Telegram. Это и есть регистрация — повторные заходы ничего не меняют.',
    tone: 'purple' as const,
  },
  {
    ...
    <section className="rounded-[24px] border border-white/8 bg-[#16121f]/95 p-5">
      ...
      <div className="mt-5 rounded-[16px] border border-white/6 bg-[#0f0d16] px-4 py-3.5">
        <p className="text-sm leading-relaxed text-[#a1a1aa]">
          ...
          <br />
          Свою ссылку открыть нельзя, а сменить пригласившего после первой
          регистрации тоже нельзя.
        </p>
      </div>
    </section>
  )
