...
export const products: ShopProduct[] = [
  ...
  },
  {
    ...
    detailText:
      'Пропустил стрим — заморозка сработает сама и стрик не сгорит. За тот стрим награды не будет, но и обнуления тоже. Можно держать сколько угодно штук, тратятся по одной.',
    infoText: 'Заморозок у тебя пока нет. Пропустишь стрим — стрик сгорит.',
    checkoutField: null,
    available: true,
  },
  {
