...
const LEGACY_TYPE_MAP = {
  ...
  CONTEST_REWARD: TX_TYPE.CONTEST_REWARD,
  LEVEL_REWARD: TX_TYPE.LEVEL_REWARD,
  MINES_BET: TX_TYPE.MINES_BET,
  MINES_WIN: TX_TYPE.MINES_WIN,
  TOWER_BET: TX_TYPE.TOWER_BET,
  TOWER_WIN: TX_TYPE.TOWER_WIN,
  ROLL_BET: TX_TYPE.ROLL_BET,
  ROLL_WIN: TX_TYPE.ROLL_WIN,
  PROMO_REWARD: TX_TYPE.PROMO_REWARD,
  PROMO_CODE: TX_TYPE.PROMO_REWARD,
